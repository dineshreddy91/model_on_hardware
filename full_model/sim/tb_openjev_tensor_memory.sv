...
module tb_openjev_tensor_memory;
  ...
  openjev_tensor_memory #(.WATCHDOG_CYCLES(80)) dut(.*);
  ...
  initial begin
    ...
    $display("PASS tensor view through AXI HBM: %0d accesses, 32 banks, strobes, AW/W stalls, bounds, protection, timeout, read error",tests);
    $finish;
  end
