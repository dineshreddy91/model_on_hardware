...
# Define AWS macros before reading any source that uses them.
...
read_verilog -sv ${src_post_enc_dir}/openjev_fp32_pkg.sv
read_verilog -sv ${src_post_enc_dir}/cl_dram_dma_pkg.sv
set openjev_module_sources {}
foreach source [lsort [glob ${src_post_enc_dir}/*.{s,}v]] {
  if {[file tail $source] ni {openjev_fp32_pkg.sv cl_dram_dma_pkg.sv}} {
    lappend openjev_module_sources $source
  }
}
read_verilog -sv $openjev_module_sources
